    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-title">Pelabuhan</li>

                <li class="sidebar-item {{ Request::routeIs('pelabuhan.dashboard') ? 'active' : '' }}">
                    <a href="{{ route('pelabuhan.dashboard') }}" class='sidebar-link'>
                        <i class="bi bi-grid-fill"></i>
                        <span>Dashboard</span>
                    </a>
                </li>
                ...
                <li class="sidebar-title">Terminal</li>

                <li class="sidebar-item {{ Request::routeIs('terminal.dashboard') ? 'active' : '' }}">
                    <a href="{{ route('terminal.dashboard') }}" class='sidebar-link'>
                        <i class="bi bi-grid-fill"></i>
                        <span>Dashboard</span>
                    </a>
                </li>
