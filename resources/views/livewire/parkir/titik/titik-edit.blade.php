<div>
    <div wire:ignore.self class="modal fade" id="editTitikModal" data-bs-backdrop="static" tabindex="-1"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editTitikModalLabel">Tambah Titik
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

                <form wire:submit="updateTitik">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal" id="close-btn-edit-titik">
                            Close
                        </button>
...
@script
    <script>
        $wire.on('trigger-close-modal', () => {
            document.getElementById('close-btn-edit-titik').click();
        });
    </script>
@endscript
