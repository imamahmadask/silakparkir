<div>
    <div wire:ignore.self class="modal fade" id="AddKorlapModal" data-bs-backdrop="static" tabindex="-1"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="AddKorlapModalLabel">Tambah Korlap
                    </h5>
                ...
                <form wire:submit="createKorlap">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal" id="close-btn-create-korlap">
                            Close
                        </button>
...
@script
    <script>
        $wire.on('trigger-close-modal', () => {
            document.getElementById('close-btn-create-korlap').click();
        });
    </script>
@endscript
